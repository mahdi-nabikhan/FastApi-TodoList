...
class UserLoginSchemas (BaseModel):
    username : str = Field(...,max_length=150,min_length=5,description='username of The user')
    password : str = Field(...,max_length=150,min_length=5,description='password  of The user')
...
class UserRegisterSchemas (BaseModel):
    username : str = Field(...,max_length=150,min_length=5,description='username of The user')
    password : str = Field(...,max_length=150,min_length=5,description='password  of The user')
    password_confirm : str = Field(...,max_length=150,min_length=5,description='password  of The user')
